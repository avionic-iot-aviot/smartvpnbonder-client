...
# 3.
sudo sed -e "s/ip_sim1/$IP_SIM1/g" /home/pi/smart_vpn/mlvpn/cfg/vpn1-support.template > /home/pi/smart_vpn/mlvpn/cfg/vpn1-support.conf
...
sudo chmod 700 /home/pi/smart_vpn/mlvpn/cfg/vpn1-support.conf
...
#    echo "launching VPN Bonding..."
    sudo /home/pi/smart_vpn/mlvpn/sbin/mlvpn -c /home/pi/smart_vpn/mlvpn/cfg/vpn1-support.conf --user root --debug -v
#fi
